...
<button class="button">BACK</button><br>
	...
	<div class="agileits-register">
		...
		String e = request.getParameter("res");
System.out.println(e);
    	...
    	try {
    		...
    		String qry ="SELECT * FROM updatedestimatecost where reason= '"+e+"'"; 
    	...
    	%>
				...
				<div class="w3_modal_body_grid w3_modal_body_grid1">
					...
					<span>Labour</span>
					<input type="text" name="labour1" readonly placeholder="Enter the square feet" value=<%=rs.getDouble("labour")%> required=""/>
					<div class="clear"> </div>
				</div>
