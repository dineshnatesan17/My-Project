...
<button class="button">BACK</button><br>
			...
			<div class="row">
					...
					<div class="table-wrap">
						<table class="table table-striped">
						  <thead>
						       ...
						       <th style="color: white;font-size:20px;">Architectural Plan</th>
						       <th style="color: white;font-size:20px;">File Name</th>
						       <th style="color: white;font-size:20px;">Structural Plan</th>
				...
				try{
		             ...
		             ResultSet rs1 = stmt1.executeQuery("SELECT * FROM siteplanup" );
          ...
          <tbody>
                ...
                <td style=padding-left:30px;font-size:20px;><%=rs1.getString("filename") %></td>
				<td><form method="get" action="Site_viewimg">
                <input type="hidden" value=<%=rs1.getString("filename")%> name="squarefeet">
                <button><img src="site_viewimg.jsp?filename=<%=rs1.getString("filename")%>" width="130" height="120"  /></button>
                </form></td>		       
