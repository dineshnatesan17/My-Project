	...
	<section class="ftco-section">
		<div class="container">
			...
			<div class="row justify-content-center">
				...
				<form action="arc_view_planstatus.jsp">
<button class="button">BACK</button>
			...
			<div class="row">
						...
						<table class="table table-striped">
						  <thead>
						    <tr style="color: white;font-size:20px;">
						      ...
						      <th style="color: white;font-size:20px;">REASON</th>
				...
				try{
		             ...
		             ResultSet rs = stmt.executeQuery("SELECT * FROM rejectedplan" );  
          ...
          <tbody>
                ...
                <td><form method="get" action="View_rej_plan">
                                <input type="hidden" value=<%=rs.getString("filename")%> name="squarefeet">
                <button><img src="view_rej_plan.jsp?filename=<%=rs.getString("filename")%>" width="130" height="120"  /></button>
                </form></td>
					<td style=padding-left:30px;font-size:20px;><%=rs.getString("status") %></td>	       
					<td style=padding-left:30px;font-size:20px;><%=rs.getString("reason") %></td>	       
