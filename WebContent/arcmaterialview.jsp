		...
		<div class="table-header">
		    ...
		    <div class="header__item"><a id="total" class="filter__link filter__link--number" href="#">Sand</a></div>
			 ...
			 <div class="header__item"><a id="total" class="filter__link filter__link--number" href="#">Aggregate</a></div>
			  <div class="header__item"><a id="total" class="filter__link filter__link--number" href="#">ProjectBudget</a></div>
		     <div class="header__item"><a id="total" class="filter__link filter__link--number" href="#">BudgetType</a></div>
		     <div class="header__item"><a id="total" class="filter__link filter__link--number" href="#">Squarefeet</a></div>
 	...
 	//	  int budget2 = Integer.parseInt(budget1);
		...
		<div class="table-content">	
			<div class="table-row">		
				...
				<div class="table-data1"><%=rs.getString("projectbudget") %></div><br><br><br>
				<div class="table-data1"><%=rs.getString("budgettype") %></div><br>
				<div class="table-data1"><%=rs.getString("squarefeet") %></div><br>
				<div class="table-data1"><%=rs.getString("status") %></div><br>
