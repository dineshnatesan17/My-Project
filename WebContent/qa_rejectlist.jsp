...
<div class="container">
	...
	<div class="table">
	<center><h2 style="color:white;background-color:black;font-size:46px;">Rejected List</h2></center><br>
		 ...
		 <% 	 
        	...
        	try{
		            ...
		            // if(budget2 == 9990000){
		            	...
		            	ResultSet rs = stmt.executeQuery("SELECT * FROM rejectedestimation ");  
