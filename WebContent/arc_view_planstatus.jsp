...
<form action="arc_view_rejectlist.jsp">
<button  class="button1">REJECTED LIST</button>
</form></div>
						...
						<table class="table table-striped">
						  <thead>
						    <tr style="color: white;font-size:20px;">
						      ...
						      <th style="color: white;font-size:20px; padding-left:220px;">File</th>
						       <th style="color: white;font-size:20px;padding-left:150px;">Status</th>
          ...
          <tbody>
                ...
                <button style= margin-left:150px;><img src="viewimage.jsp?filename=<%=rs.getString("filename")%>" width="130" height="120"  /></button>
					...
					<td style=padding-left:150px;font-size:20px;><%=rs.getString("status") %></td>	
