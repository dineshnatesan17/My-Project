...
<div class="container">
	...
	<div class="table">
	<center><h2 style="color:white;background-color:black;font-size:46px;"> VIEW ESTIMATION</h2></center><br>
		 ...
		 <% 	 
        	...
        	try{
		            ...
		            // if(budget2 == 9990000){
		            	...
		            	ResultSet rs = stmt.executeQuery("SELECT * FROM materialcost ");  
		...
		<div class="table-content">	
			<div class="table-row">		
				<div class="table-data">
							<h4 style="color: black;">QUANTITY: 12.8%</h4><br>
