...
<div class="container">
	...
	<div class="table">
	<center><h2 style="color:white;background-color:black;font-size:46px;">DATE UPDATION</h2></center><br>
		...
		<div class="table-content">	
			<div class="table-row">		
				<div class="table-data">
							...
							<%=rs.getString("fixeddate") %></div>
				
		<div class="table-data"><td> <form method="" action="site_view_datefix1.jsp" >
               <button id="myBtn"  style="background:green; color:white; height:40px; width:90px;">Update</button>
                </form></td></div>
