...
<button class="button">BACK</button><br>
	...
	<div class="agileits-register">
		<form action="update_project_status1.jsp" method="post">
				...
				<div class="w3_modal_body_grid w3_modal_body_grid1">
					...
					<input type="text" name="date" readonly placeholder="Enter the square feet" value="<%= new java.util.Date() %>" required=""/>
					<div class="clear"> </div>
				</div>
				...
				<div class="w3_modal_body_grid w3_modal_body_grid1">
					...
					<textarea name="status" style="width: 200px;height: 100px; padding: 10px; border:3px dashed indigo; background-color:black; color: white"> </textarea>
					<div class="clear"> </div>
				</div>
